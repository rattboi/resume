...
\begin{itemize}
  ...
  \headerrow
	...
	\\
  Participated in developing an autonomous quadcopter (4-rotor helicopter). Contributed to integrating various sensors to the quadcopter, specifically an infrared range finder for flight height information. Wrote embedded software for the LPCxpresso board that powers the flight computer. Developed documentation for other parts of the low and high-level systems.
